...
<body>
  <div class="container">
    <nav><a class="none" href="index.php">
        <h3 class="mt-3"><img src="img/notepad2.png">NotepadKu</h3>
      </a></nav>
    ...
    ?>
      <div class="card mb-2 kartu">
        <div class="card-body">
          <h5 class="card-title"><?php echo ++$no ?>. <?php echo $result['title_note']; ?></h5>
          <p class="card-text"><?php echo $result['note_note']; ?></p>
          <a href="update.php?edit=<?php echo $result['id_note']; ?>" class="card-link">Edit</a>
          <a href="delete.php?delete=<?php echo $result['id_note']; ?>" class="card-link">Delete</a>
        </div>
      </div>
    <?php
    }
